...
class TimeDelay(object):
    ...
    def log_like_add(self,lens,cosmo):
        ...
        """
        dd = cosmo.angular_diameter_distance(lens.zlens)
        ds = cosmo.angular_diameter_distance(lens.zsource)
        dds = cosmo.angular_diameter_distance_z1z2(lens.zlens, lens.zsource)
